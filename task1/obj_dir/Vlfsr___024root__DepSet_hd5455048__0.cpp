...
VL_INLINE_OPT void Vlfsr___024root___sequent__TOP__0(Vlfsr___024root* vlSelf) {
    ...
    if (vlSelf->rst) {
        ...
        __Vdly__lfsr__DOT__sreg = ((0xfcU & (IData)(__Vdly__lfsr__DOT__sreg)) 
                                   | ((2U & ((IData)(vlSelf->lfsr__DOT__sreg) 
                                             << 1U)) 
                                      | (1U & VL_REDXOR_8(
                                                          (0x44U 
                                                           & (IData)(vlSelf->lfsr__DOT__sreg))))));
        __Vdly__lfsr__DOT__sreg = ((3U & (IData)(__Vdly__lfsr__DOT__sreg)) 
                                   | (0xfcU & ((IData)(vlSelf->lfsr__DOT__sreg) 
                                               << 1U)));
    }
